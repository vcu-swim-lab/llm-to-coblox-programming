...
*/
const savedPos = Array.from(savedVariables);

const template = PromptTemplate.fromTemplate("You are an assistant ai, your job is to write Blockly XML code to move a robot, and have that robot pick up and release items.\
...
const formattedTemplate = await template.format({ positions: savedPos });
